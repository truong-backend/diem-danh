  ...
  return (
    <div className="p-6 max-w-md mx-auto">
      <div className="text-center mb-6">
        <h1 className="text-2xl font-bold text-slate-900">Điểm danh QR</h1>
        <p className="text-slate-500 mt-1">Quét mã QR từ giáo viên để điểm danh</p>
      </div>
        ...
        {result ? (
          ...
          <div className="flex flex-col items-center gap-5 py-6">
            ...
            <div className="text-center space-y-1">
              <p className="font-semibold text-xl text-slate-900">Điểm danh thành công!</p>
              {result.session && (
